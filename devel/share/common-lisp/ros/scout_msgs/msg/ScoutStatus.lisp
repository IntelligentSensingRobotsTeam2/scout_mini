...
(cl:defclass <ScoutStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (angular_velocity
    ...
    :type cl:float
    :initform 0.0)
   (transverse_linear_velocity
    :reader transverse_linear_velocity
    :initarg :transverse_linear_velocity
    :type cl:float
    :initform 0.0)
   (base_state
    :reader base_state
...
(cl:ensure-generic-function 'transverse_linear_velocity-val :lambda-list '(m))
(cl:defmethod transverse_linear_velocity-val ((m <ScoutStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_msgs-msg:transverse_linear_velocity-val is deprecated.  Use scout_msgs-msg:transverse_linear_velocity instead.")
  (transverse_linear_velocity m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ScoutStatus>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'angular_velocity))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'transverse_linear_velocity))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ScoutStatus>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'transverse_linear_velocity) (roslisp-utils:decode-double-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ScoutStatus>)))
  ...
  "fef327f257c6c79882a0f333c289c7dd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ScoutStatus)))
  "Returns md5sum for a message object of type 'ScoutStatus"
  "fef327f257c6c79882a0f333c289c7dd")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ScoutStatus>))
  ...
  (cl:list 'ScoutStatus
    ...
    (cl:cons ':transverse_linear_velocity (transverse_linear_velocity msg))
